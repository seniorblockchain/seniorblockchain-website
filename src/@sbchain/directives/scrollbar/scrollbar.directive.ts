...
import { ScrollbarGeometry, ScrollbarPosition } from '@sbchain/directives/scrollbar/scrollbar.types';

/**
 * Wrapper directive for the Perfect Scrollbar: https://github.com/mdbootstrap/perfect-scrollbar
 */
@Directive({
    selector: '[sbchainScrollbar]',
    exportAs: 'sbchainScrollbar'
})
export class SBChainScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_sbchainScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() sbchainScrollbar: boolean = true;
    @Input() sbchainScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'sbchainScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.sbchainScrollbar = coerceBooleanProperty(changes.sbchainScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.sbchainScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'sbchainScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.sbchainScrollbarOptions.currentValue);
