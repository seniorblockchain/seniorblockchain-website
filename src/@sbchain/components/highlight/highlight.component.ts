...
import { SBChainHighlightService } from '@sbchain/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[sbchain-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'sbchainHighlight'
})
export class SBChainHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _sbchainHighlightService: SBChainHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._sbchainHighlightService.highlight(this.code, this.lang));
