...
import { FSDocument, FSDocumentElement } from '@sbchain/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'sbchain-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'sbchainFullscreen'
})
export class SBChainFullscreenComponent implements OnInit
{
