...
import { SBChainMockApiReplyCallback } from '@sbchain/lib/mock-api/mock-api.types';

export class SBChainMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: SBChainMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: SBChainMockApiReplyCallback): void
    {
        // Store the reply
