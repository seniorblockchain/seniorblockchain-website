...
import { categories as categoriesData, courses as coursesData, demoCourseSteps as demoCourseStepsData } from 'app/mock-api/apps/docs/data';
...
export class DocsMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._sbchainMockApiService
            .onGet('api/apps/docs/categories')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._sbchainMockApiService
            .onGet('api/apps/docs/courses/course')
            .reply(({request}) => {
