...
export class DocsService
{
    ...
    {
        return this._httpClient.get<Category[]>('api/apps/docs/categories').pipe(
            tap((response: any) => {
    ...
    {
        return this._httpClient.get<Course[]>('api/apps/docs/courses').pipe(
            tap((response: any) => {
    ...
    {
        return this._httpClient.get<Course>('api/apps/docs/courses/course', {params: {id}}).pipe(
            map((course) => {
